...
def objective_function(p):
        score = cross_validate(
            ...
            reg_alpha=p[5],
            reg_lambda=p[6]
            ), X_train, Y_train, scoring=scorer, return_train_score=True)
...
conf = [1.58558243e-01,1.02832329e+02, 1.37734220e+01, 1.49902773e+00, 7.96725621e-01, 5.73544198e-05, 5.68694347e-01]
print(objective_function(conf))